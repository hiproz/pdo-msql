srcdir = /data/php/PDO_MYSQL-1.0.2
builddir = /data/php/PDO_MYSQL-1.0.2
top_srcdir = /data/php/PDO_MYSQL-1.0.2
top_builddir = /data/php/PDO_MYSQL-1.0.2
...
RE2C = exit 0;
AWK = gawk
shared_objects_pdo_mysql = pdo_mysql.lo mysql_driver.lo mysql_statement.lo
PHP_PECL_EXTENSION = pdo_mysql
PDO_MYSQL_SHARED_LIBADD = -L/usr/lib64/mysql -lmysqlclient -lpthread -lz -lm -ldl -lssl -lcrypto
PDO_MYSQL_MODULE_TYPE = external
PHP_MODULES = $(phplibdir)/pdo_mysql.la
PHP_ZEND_EX =
...
prefix = /usr
phplibdir = /data/php/PDO_MYSQL-1.0.2/modules
